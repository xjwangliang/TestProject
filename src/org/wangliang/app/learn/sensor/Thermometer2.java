...
public final class Thermometer2 extends View implements SensorEventListener {
	...
	private String scaleUpperTitle = "atstechlab.wordpress.com";
	private String scaleLowerTitle = "mindtherobot.com";
	...
	public Thermometer2(Context context) {
		super(context);
		init(context, null);
	}

	public Thermometer2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}

	public Thermometer2(Context context, AttributeSet attrs, int defStyle) {
