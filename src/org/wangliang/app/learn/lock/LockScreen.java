//package org.wangliang.app.learn.lock;
//
...
//		final boolean isMonkey = SystemProperties
//				.getBoolean("ro.monkey", false);
...
//			if (mSilentMode) {
//				final boolean vibe = (Settings.System.getInt(getContext()
//						.getContentResolver(),
//						Settings.System.VIBRATE_IN_SILENT, 1) == 1);
//
//				mAudioManager
//						.setRingerMode(vibe ? AudioManager.RINGER_MODE_VIBRATE
...
//
//			final int toastColor = mSilentMode ? getContext().getResources()
//					.getColor(R.color.keyguard_text_color_soundoff)
...
//	 *            The text.
//	 * @param color
//	 *            The color to apply to the text, or 0 if the existing color
//	 *            should be used.
...
//		if (mNextAlarm != null) {
//			mAlarmIcon = getContext().getResources().getDrawable(
...
//		if (DBG)
//			Log.d(TAG, "onRefreshBatteryInfo(" + showBatteryInfo + ", "
//					+ pluggedIn + ")");
...
//			mStatus1.setCompoundDrawablesWithIntrinsicBounds(mChargingIcon,
//					null, null, null);
...
//			mStatus1.setCompoundDrawablesWithIntrinsicBounds(mAlarmIcon, null,
//					null, null);
//		} else if (mCharging != null && mNextAlarm != null) {
...
//			mStatus2.setCompoundDrawablesWithIntrinsicBounds(mAlarmIcon, null,
//					null, null);
//		}
//	}
//
...
//		boolean missingAndNotProvisioned = (!mUpdateMonitor
//				.isDeviceProvisioned() && simState == IccCard.State.ABSENT);
...
//			break;
//		case NetworkLocked:
//			// The carrier string shows both sim card status (i.e. No Sim Card)
//			// and
//			// carrier's name and/or "Emergency Calls Only" status
//			mCarrier.setText(getCarrierString(
//					mUpdateMonitor.getTelephonyPlmn(),
//					getContext().getText(
//							R.string.lockscreen_network_locked_message)));
//			mScreenLocked
//					.setText(R.string.lockscreen_instructions_when_pattern_disabled);
//
//			// layout
//			mScreenLocked.setVisibility(View.VISIBLE);
//			mSelector.setVisibility(View.VISIBLE);
...
//			mScreenLocked
//					.setText(R.string.lockscreen_sim_puk_locked_instructions);
//
//			// layout
//			mScreenLocked.setVisibility(View.VISIBLE);
//			mSelector.setVisibility(View.GONE); // cannot unlock
...
//	}
//
//	static CharSequence getCarrierString(CharSequence telephonyPlmn,
